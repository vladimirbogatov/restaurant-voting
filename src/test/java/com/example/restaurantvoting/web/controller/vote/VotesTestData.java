...
public class VotesTestData {
    ...
    public static final VoteTo ADMIN_TO_VOTE_20220430 = new VoteTo(VOTE_ID, RESTAURANT3.getId(), LocalDate.of(2022, 4, 30));
    public static final VoteTo USER_TO_VOTE_20220430 = new VoteTo(VOTE_ID + 1, RESTAURANT2.getId(), LocalDate.of(2022, 4, 30));
    public static final VoteTo ADMIN_TO_VOTE_20220501 = new VoteTo(VOTE_ID + 2, RESTAURANT1.getId(), LocalDate.of(2022, 5, 1));
    public static final VoteTo USER_TO_VOTE_20220501 = new VoteTo(VOTE_ID + 3, RESTAURANT1.getId(), LocalDate.of(2022, 5, 1));
    public static final VoteTo ADMIN_TO_VOTE_20220502 = new VoteTo(VOTE_ID + 4, RESTAURANT2.getId(), LocalDate.of(2022, 5, 2));
